...
const SortMenu = ({ sortFn }) => {
    ...
    return (
        <div className="sort-menu-dropdown">
            <button className="sort-menu-dropdown-toggle" type="button" onClick={toggleMenuVisibility}>Sort {isAscending ? <LiaSortAlphaDownSolid onClick={toggleAscending} /> : <LiaSortAlphaUpSolid onClick={toggleAscending} />}</button>
